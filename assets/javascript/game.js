...
// 1.) When page loads..
    ...
    //this writes the reulting underscores on the page in HTML
    //document.querySelector('#hiddenWord').innerHTML = 
    //`${hRandWord}`;
    
    //the count of guessesLeft, wins, and loses is written on the page with innerHTML
    let gLeft = 10;
